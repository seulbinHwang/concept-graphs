...
def main(cfg: DictConfig):
    ...
    for idx in trange(len(dataset)):
        ...
        image_crops, image_feats, text_feats = compute_clip_features_batched(
            image_rgb, detections, clip_model, clip_preprocess, clip_tokenizer,
            classes, cfg.device)
